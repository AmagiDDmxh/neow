...
export class RPCClient {
  ...
  getBlock (
    indexOrHash: string | number, verbose?: number): Promise<object | string>
  ...
  invokeFunction (
    scriptHash: string, operation: string,
    params: Array<any>
  ): Promise<object>
...
export class Query {
  ...
  static invokeFunction (
    scriptHash: string, operation: string, params: Array<any>): Query
